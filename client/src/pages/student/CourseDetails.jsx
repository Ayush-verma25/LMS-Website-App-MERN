          ...
          <div className="p-5">
            <div className="flex items-center gap-2">
              ...
              <p className="text-orange-500">
                <span className="font-medium">5 days</span> left to buy this
                course at discounted price!
              </p>
            </div>
            ...
            <div className="pt-6">
              ...
              <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500">
                ...
                <li>Certificate of Completion valid for Lifetime.</li>
                <li>
                  Downloadable all Lectures with Hands-on project & Source Code.
                </li>
                <li>Quizes & Practice Problems to test your knowledge.</li>
                <li>Free Consultation Step_by_Step with our Experts.</li>
              </ul>
            </div>
          </div>
        </div>
